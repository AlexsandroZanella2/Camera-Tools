...
public class SelfieSegmentation(var _context: Context): MethodChannelInterface {
    private val START: String = "start#SelfieSegmentation"
    private val CLOSE: String = "close#SelfieSegmentation"
